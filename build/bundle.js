...
var Game = function () {
	function Game(element, width, height) {
		...
		this.player4 = new _Paddle2.default(this.height, this.paddleWidth, this.paddleHeight, this.width / 2, (this.height - this.paddleHeight) / 4, _settings.KEYS.a, _settings.KEYS.z);

		this.ball = new _Ball2.default(this.ballRadius, this.width, this.height);

		this.greenBall = new _Ball2.default(this.ballRadius - 1, this.width, this.height);

		this.score1 = new _Score2.default(this.width / 2 - 150, 30, 30);
		this.score2 = new _Score2.default(this.width / 2 + 130, 30, 30);
  ...
  _createClass(Ball, [{
    ...
    value: function paddleCollision(player1, player2) {
      if (this.vx > 0) {
        ...
        var _paddle2 = player1.coordinates(player1.x, player1.y, player1.width, player2.height);
    ...
    key: 'render',
    value: function render(svg, player1, player2, greenBall) {
      this.x += this.vx;
      this.y += this.vy;
